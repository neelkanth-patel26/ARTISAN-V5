...
export function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 py-4 md:py-6 bg-gradient-to-b from-black/50 via-black/30 to-transparent backdrop-blur-sm border-b border-amber-600/10 pt-[max(38px,env(safe-area-inset-top))]"
    >
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-screen w-full md:w-[420px] bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950 border-l border-amber-600/20 shadow-2xl z-[60] overflow-hidden pt-[max(38px,env(safe-area-inset-top))]"
            >
