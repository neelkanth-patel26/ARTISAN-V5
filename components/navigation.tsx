...
export function Navigation() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 py-2 md:py-6 bg-gradient-to-b from-black/50 via-black/30 to-transparent [.native-mode_&]:bg-gradient-to-r [.native-mode_&]:from-neutral-950 [.native-mode_&]:to-neutral-900 backdrop-blur-sm border-b border-amber-600/10 pt-[max(12px,env(safe-area-inset-top))] [.native-mode_&]:pt-[max(32px,env(safe-area-inset-top))]"
    >
