    ...
    <>
      ...
      {!loading && (
        <div className={`min-h-screen bg-gradient-to-b from-neutral-950 via-neutral-900 to-neutral-950 overflow-x-hidden ${deviceType === 'desktop' || deviceType === 'pwa-desktop' ? 'overflow-y-hidden h-screen' : 'overflow-y-auto scrollbar-hide'}`} style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          ...
          {/* Features Section */}
          <section className="min-h-screen h-screen flex items-center py-16 sm:py-32 px-4 sm:px-6 bg-gradient-to-b from-transparent via-neutral-950/50 to-transparent relative">
            <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="1"%3E%3Cpath d="M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
            <div className="max-w-7xl mx-auto w-full">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <h2 className="text-3xl sm:text-5xl md:text-6xl font-light text-white mb-4 sm:mb-6" style={{ fontFamily: 'ForestSmooth, serif' }}>
                ...
                <p className="text-base sm:text-xl text-neutral-400 max-w-2xl mx-auto">Powerful tools designed for modern artists</p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="group relative p-4 sm:p-8 bg-neutral-900/50 border border-neutral-800 hover:border-amber-600/30 rounded-2xl transition-all cursor-pointer overflow-hidden"
                  >
                    ...
                    <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${feature.color} p-0.5 mb-4 sm:mb-6`}>
                      <div className="w-full h-full bg-neutral-900 rounded-xl flex items-center justify-center">
                        <feature.icon className="w-5 h-5 sm:w-7 sm:h-7 text-amber-500" />
                      </div>
                    </div>
                    <h3 className="text-lg sm:text-2xl font-light text-white mb-2 sm:mb-3" style={{ fontFamily: 'ForestSmooth, serif' }}>{feature.title}</h3>
          ...
          {/* CTA Section */}
          <section className="min-h-screen h-screen flex items-center py-16 sm:py-32 px-4 sm:px-6 relative overflow-hidden">
            <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="1"%3E%3Cpath d="M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 w-full">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-6xl md:text-7xl font-light text-white mb-6 sm:mb-8 leading-tight px-4" style={{ fontFamily: 'ForestSmooth, serif' }}>
                  Ready to Start Your Journey?
                </h2>
                <p className="text-lg sm:text-2xl text-neutral-400 mb-8 sm:mb-12 leading-relaxed px-4">
                ...
                <Link href="/artist">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group px-8 sm:px-12 py-4 sm:py-5 bg-gradient-to-r from-amber-600 to-amber-500 text-white text-sm sm:text-base tracking-wider rounded-xl font-medium inline-flex items-center gap-2 sm:gap-3 shadow-2xl shadow-amber-600/40"
                  >
                    GET STARTED NOW
          ...
          {/* Footer */}
          <footer className="min-h-screen h-screen flex items-center py-12 sm:py-16 px-4 sm:px-6 border-t border-neutral-800/50 bg-neutral-950/50">
            <div className="max-w-7xl mx-auto w-full">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
                <div className="col-span-2 md:col-span-1">
                  <span className="text-lg sm:text-xl font-light tracking-[0.3em] text-white mb-3 sm:mb-4 block" style={{ fontFamily: 'ForestSmooth, serif' }}>ARTISAN</span>
                  <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed">Empowering artists to turn their passion into income.</p>
                </div>
                <div>
                  <h4 className="text-xs tracking-[0.2em] text-amber-600/70 font-light mb-3 sm:mb-4 uppercase">Platform</h4>
                ...
                <div>
                  <h4 className="text-xs tracking-[0.2em] text-amber-600/70 font-light mb-3 sm:mb-4 uppercase">For Artists</h4>
                  <ul className="space-y-1.5 sm:space-y-2">
                ...
                <div>
                  <h4 className="text-xs tracking-[0.2em] text-amber-600/70 font-light mb-3 sm:mb-4 uppercase">Support</h4>
                  <ul className="space-y-1.5 sm:space-y-2">
              ...
              <div className="pt-6 sm:pt-8 border-t border-neutral-800/30 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
                <p className="text-neutral-500 text-xs sm:text-sm text-center md:text-left">© 2026 Gaming Network Studio Media Group</p>
                <p className="text-neutral-600 text-[10px] sm:text-xs">Made By Group 1</p>
              </div>
            </div>
          </footer>
          </div>
